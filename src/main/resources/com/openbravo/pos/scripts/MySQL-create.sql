...
CREATE TABLE `customers` (
	...
	`taxcategory` varchar(70) default NULL,
...
CREATE TABLE `products` (
	...
	`texttip` varchar(100) default NULL,
	`warranty` smallint(6) NOT NULL default '0',
	`stockunits` double NOT NULL default '0',
	`printto` varchar(100) default '1',
	`supplier` varchar(70) default NULL,
        `uom` varchar(100) default '0',
...
CREATE TABLE `thirdparties` (
	...
	`name` varchar(100) NOT NULL,
	`address` varchar(255) default NULL,
	`contactcomm` varchar(100) default NULL,
	`contactfact` varchar(100) default NULL,
	`payrule` varchar(150) default NULL,
